...
switchStmt
    : SWITCH LPAREN expresion RPAREN LBRACE caseBlock* defaultBlock? RBRACE
    ;

caseBlock
    : CASE INT COLON (sentencia SEMI?)*
    ;

defaultBlock
    : DEFAULT COLON (sentencia SEMI?)*
    ;
...
forStmt
    : FOR LPAREN asignacion SEMI condicion SEMI asignacion RPAREN
      LBRACE (sentencia SEMI?)* RBRACE
    ;
